...
# timeSeries Plot
plot(names(meanStepsInterval),meanStepsInterval, type="l", main="Avg Steps in 5 min intervals across all days", xlab="5 min interval HHMM or HMM")
...
hist(totalStepsPD2,breaks=10,col="red", main="Histogram of the total number of steps per day(with imputed values)")
...
dataImputed$weekend=ifelse(dataImputed$weekend %in% c("Saturday","Sunday"),"weekend","weekday")
